# Evidence ledger — leading external systems for CycleWarden
...
|---|---|---|---|
| H1 | CycleWarden should own durable decision, policy, evidence, and outcome semantics while integrating interchangeable runtimes. | High for architecture; low for market value | A compatible system provides the complete job with lower cost and users prefer it. |
| H2 | “Agent control plane” is not a differentiated product position by itself. | High | Competitor scope proves materially narrower and users identify CycleWarden's generic control-plane layer as the missing job. |
...
| E21 | No interviews, observed behavior, product analytics, or paid pilot in this cycle establishes that users value CycleWarden's decision governance. | Research scope and [`BRIEF.md`](./BRIEF.md), 2026-07-23 | 5 | Limits H1 and H4 | Evidence gap | High | Issue #14 remains the product gate. |

## Contradictions and gaps

| Topic | Supporting | Contradicting | Missing | Decision impact |
|---|---|---|---|---|
| CycleWarden is differentiated as a control plane | E1 | E6, E14, E16 | Direct user comparison | Stop leading with the generic label; focus on decision-to-outcome proof. |
...
| A public coding score proves quality | E10 | E18, E19, E20 | CycleWarden-specific outcome suite | Reject a single benchmark gate. |
...
1. keep CycleWarden's portable deterministic decision/evidence kernel;
