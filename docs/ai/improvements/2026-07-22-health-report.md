...
Objective: prove the autonomous workflow can make Shipkit more truthful and agent-legible  
Autonomy level: A3  
...
- Repository/branch: `Thunderkill016/shipkit`, `agent/ai-engineering-workflow`.
...
| F4 | Product | `IDEA.md` describes a demo product, while README/roadmap position Shipkit itself as the product | Discovery and prioritization can target the wrong product | `IDEA.md`, `README.md`, `ROADMAP.md` | High | Simplify |
...
| 5 | Rewrite `IDEA.md` as Shipkit's actual product definition | Better product research and prioritization | Medium | High | Medium | Low | Low | High | Human product decision |
